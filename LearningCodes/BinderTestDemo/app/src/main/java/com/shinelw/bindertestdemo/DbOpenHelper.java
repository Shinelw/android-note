...
public class DbOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String USER_TALBLE_NAME = "user";

    private static final int DB_VERSION = 1;

    //图书和用户信息表
    private String CREATE_BOOK_TABLE = "CREATE TABLE IF NOT EXISTS " + BOOK_TABLE_NAME + " (_id INTEGER PRIMARY KEY, " + "name TEXT) ";
    private String CREATE_USER_TABLE = "CREATE TABLE IF NOT EXISTS " + USER_TALBLE_NAME + " (_id INTEGER PRIMARY KEY," + "name TEXT, " + "sex INT)";
